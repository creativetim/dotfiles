...
alias f='find . -iname'
alias flashi='brew cask install flash-npapi && brew cask install flash-ppapi'
...
alias serve='p -m SimpleHTTPServer'
...
# Make command to simplify youtube-dl https://www.youtube.com/watch?v=VTUMDQ4jYRM -r 50M -f 'bestvideo[ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best'
